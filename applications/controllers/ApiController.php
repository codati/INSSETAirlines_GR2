...
class ApiController extends Zend_Controller_Action
{
	...
	/**
	 * Page index du contrôleur api. N'affiche rien.
	 * 
	 * @return null
	 */
	...
	/**
	 * Retourne les informations sur une reservation au format json
	 * 
	 * @return null
	 */
	public function infosresajsonAction()
	{
		...
		if ($id_resa > 0) {
			...
			if ($resInfo_resa) {
				...
				if ($resInfo_resa['nbEscale'] > 0) {
					...
					foreach ($resInfosEscales as $i => $InfosEscales) {
						...
						if ($InfosEscales['datehArriveeEffectiveEscale'] != null) {
							...
							$escales[$i]['datehArriveeEffectiveEscale'] = 0;
						}
						...
						if ($InfosEscales['datehArriveePrevueEscale'] != null) {
							...
							$escales[$i]['datehArriveePrevueEscale'] = 0;
						}
						...
						if ($InfosEscales['datehDepartEffectiveEscale'] != null) {
							...
							$escales[$i]['datehDepartEffectiveEscale'] = 0;
						}
						...
						if ($InfosEscales['datehDepartPrevueEscale'] != null) {
							...
							$escales[$i]['datehDepartPrevueEscale'] = 0;
						}
					}
				}
				...
				//On passe les dates des infos de la réservation (1ere requête) 
				//en timestamp (demandé pour l'appli android)
				if ($resInfo_resa['dateHeureDepartEffectiveVol'] != null) {
					...
					$data['dateHeureDepartEffectiveVol'] = 0;
				}
				...
				if ($resInfo_resa['dateHeureDepartPrevueVol'] != null) {
					...
					$data['dateHeureDepartPrevueVol'] = 0;
				}
				...
				if ($resInfo_resa['dateHeureArriveeEffectiveVol'] != null) {
					...
					$data['dateHeureArriveeEffectiveVol'] = 0;
                }
				...
				if ($resInfo_resa['dateHeureArriveePrevueVol'] != null) {
					...
					$data['dateHeureArriveePrevueVol'] = 0;
				}
			} else {
				$erreur = 1;
    ...
    /**
	 * Renvoi un code pour l'api de maintenance suite à la connexion d'un user.
	 * 
	 * @return null
	 */
    ...
    /**
	 * Renvoi la liste des interventions pour l'api maintenance
	 * 
	 * @return null
	 */
    ...
    /**
	 * Modifie une intervention depuis l'api
	 * 
	 * @return null
	 */
