...
function modifierIntervention(numIntervention, idTech) {
    //alert($('#recupTaf_'+numIntervention+' td.taff').text());
    ...
    $('#int_'+numIntervention+' td.tacheEff').html('<input id="focus_'+numIntervention+'" type="text" name="modifiertache" />');
    $('#focus_'+numIntervention).val(defautTache);
